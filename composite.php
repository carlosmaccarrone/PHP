<?php
// El patrón Composite sirve para construir objetos generando una estructura de 
// composición recursiva de árbol binario. Esto simplifica el tratamiento de los  
